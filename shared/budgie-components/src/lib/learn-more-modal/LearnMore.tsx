...
const LearnMore: React.FC<LearnMoreProps> = ({ onClose }) => {
  return (
    <div className="bg-BudgieBlue w-[794px] h-[521px] rounded-[61px] p-8 overflow-auto">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-white">
            ...
            <li>
              Feature 2: Predictive analytics for future spending based on past
              patterns.
            </li>
          </ul>
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="mb-2 text-BudgieGreen3 text-white">
            Follow these simple steps to get started:
          </p>
          <ol className="list-decimal list-inside ml-4 text-white">
